...
namespace TurismoGlobalArandas.Context
{
    public class TurismoGlobalContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Commissions>().HasData(new Commissions {CommissionId =11, ProviderId = 11, Color = null, CommissionAgency = 0.10, CommissionClient = 0.05,CommissionEmployee = 0.05, Description=null, IsDeleted = false });
