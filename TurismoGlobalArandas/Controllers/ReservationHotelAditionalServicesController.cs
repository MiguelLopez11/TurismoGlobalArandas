...
namespace TurismoGlobalArandas.Controllers
{
    ...
    public class ReservationHotelAditionalServicesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ReservationHotelsServicesAditionals>> GetReservationHotelsServicesAditionals()
        {
        ...
        public async Task<ActionResult<ReservationHotelsServicesAditionals>> GetReservationHotelsServicesAditionalHotelId(int ReservationHotelId)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<ReservationHotelsServicesAditionals>> PostReservationHotelsServicesAditional(ReservationHotelsServicesAditionals habitationsReservation)
        {
            _context.ReservationHotelsServicesAditionals.Add(habitationsReservation);
            await _context.SaveChangesAsync();
            return CreatedAtAction("getReservationHotelsServicesAditionalById", new { Id = habitationsReservation.Id }, habitationsReservation);
        }
        [HttpPut("{Id}")]
        public async Task<ActionResult> PutReservationHotelsServicesAditional(int Id, ReservationHotelsServicesAditionals reservationsServicesAditionals)
        {
            if (reservationsServicesAditionals.Id != Id)
            {
                return Ok("Los Id ingresados no coinciden");
            }
            var reservationsServicesAditionalsOld = await _context.ReservationHotelsServicesAditionals
                .FirstOrDefaultAsync(f => f.Id == Id);
            ...
            reservationsServicesAditionalsOld.AditionalServiceId = reservationsServicesAditionals.AditionalServiceId;
            reservationsServicesAditionalsOld.ReservationHotelId = reservationsServicesAditionals.ReservationHotelId;
        ...
        {
            var reservationService = await _context.ReservationHotelsServicesAditionals
                .FirstOrDefaultAsync(f => f.Id == Id);
