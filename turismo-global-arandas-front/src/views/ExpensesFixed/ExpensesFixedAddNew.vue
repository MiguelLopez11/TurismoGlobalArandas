<template>
  <el-dialog v-model="isOpenDialog" title="Nuevo gasto fijo" width="50%" center>
    <Form
      ref="expenseFixedFormRef"
      as="el-form"
...
export default {
  setup () {
    const isOpenDialog = inject('addExpenseFixed')
    const swal = inject('$swal')
    const expenseFixedFormRef = ref(null)
    const { createExpense } = ExpenseFixedServices()
