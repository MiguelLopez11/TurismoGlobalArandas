              ...
              <el-dropdown>
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    ...
                    >
                    <el-dropdown-item
                      @click="onDeleteRoute(items.routeId)"
...
import RoutesAddNew from './RoutesAddNew.vue'

export default {
  components: { RoutesAddNew },
  setup () {
    const { getRoutes, deleteRoute } = RouteServices()
    const routes = ref([])
          ...
          if (result.isConfirmed) {
            deleteRoute(routeId, data => {
              swal.fire({
                ...
                text: 'La ruta ha sido eliminado satisfactoriamente .',
                icon: 'success'
              })
              refreshTable()
            })
